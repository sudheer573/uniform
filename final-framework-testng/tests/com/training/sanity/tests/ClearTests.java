...
public class ClearTests {
	...
	public void validClearTest() {
		...
		clearPOM.sendFirstNAME("Sudheer");
		clearPOM.sendLastName("Kumar");
		clearPOM.sendEmail("sudheer.katikireddy@gmail.com");
		clearPOM.sendTelephone("9959600475");
		clearPOM.clickContinue();
	}
}